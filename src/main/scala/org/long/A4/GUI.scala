...
object GUI {
  ...
  val aboutIcon = new ImageIcon(getClass.getResource("/res/about64.png"))
  val infoIcon = new ImageIcon(getClass.getResource("/res/info64.png"))
  val errorIcon = new ImageIcon(getClass.getResource("/res/error64.png"))
  val searchIcon = new ImageIcon(getClass.getResource("/res/search32.png"))
  val clearIcon = new ImageIcon(getClass.getResource("/res/bin32.png"))
  val saveIcon = new ImageIcon(getClass.getResource("/res/save32.png"))
