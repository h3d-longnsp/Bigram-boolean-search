...
object GUI {
  ...
  val appIcon = new ImageIcon("resources/res/app512.png")
  val loadingIcon = new ImageIcon("resources/res/loading.gif")
  val aboutIcon = new ImageIcon("resources/res/about64.png")
  val infoIcon = new ImageIcon("resources/res/info64.png")
  val errorIcon = new ImageIcon("resources/res/error64.png")
  val searchIcon = new ImageIcon("resources/res/search32.png")
  val clearIcon = new ImageIcon("resources/res/bin32.png")
  val saveIcon = new ImageIcon("resources/res/save32.png")
  val checkIcon = new ImageIcon("resources/res/check32.png")
  val uncheckIcon = new ImageIcon("resources/res/uncheck32.png")
  val catIcon = new ImageIcon("resources/res/cat128.png")
